...
"[project]/src/db/scode.json (json)": ((__turbopack_context__) => {
...
"[project]/src/db/sarea.json (json)": ((__turbopack_context__) => {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$scode$2e$json__$28$json$29$__ = __turbopack_context__.i("[project]/src/db/scode.json (json)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$sarea$2e$json__$28$json$29$__ = __turbopack_context__.i("[project]/src/db/sarea.json (json)");
;
...
function Subway() {
    _s();
    const [login] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jotai$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAtom"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$atoms$2f$IsLogin$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logAtom"]);
    ...
    const selList = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$sarea$2e$json__$28$json$29$__["default"].map((item)=>item["측정소"]);
    const getYesterday = ()=>{
        let dt = new Date();
    ...
    const handleChange = ()=>{
        ...
        const codes = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$sarea$2e$json__$28$json$29$__["default"].map((item)=>`${item["측정소"]},${item["코드"]}`); // json은 ":" 말고 "as"
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Subway.useEffect": ()=>{
            if (!data) return;
            const itemKeys = Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$scode$2e$json__$28$json$29$__["default"]);
            const scodeT = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$scode$2e$json__$28$json$29$__["default"];
            let tm = itemKeys.map({
...
//# sourceMappingURL=_3abb90c3._.js.map